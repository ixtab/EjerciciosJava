...
public class Inicio {
	...
	public static void main(String[] args) {
		...
		Coche miCoche = new Coche("5568FJK","Ford","Fiesta", miMotor); // Composicion débil.
		...
		Coche miCoche2 = new Coche("5522FGH","Citroen","C1", 150, 0); // Composión fuerte.
		System.out.println(miCoche2.estado());
		
		System.out.println("Total coches " + Coche.contadorCoches);
		// System.out.println("Total coches " + miCoche2.contadorCoches);  Se podría acceder así, pero no es lo correcto.
